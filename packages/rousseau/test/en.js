...
describe("English", function () {
    describe("Adverbs", function () {
        it("should detect", function (done) {
            testRousseau(
                "Allegedly, this sentence is terrible.",
                {
                    only: ["adverbs"]
                },
                done,
    ...
    describe("Sentences", function () {
        describe("Start", function () {
            it("should detect sentences not starting with a space", function (done) {
                testRousseau(
                    "Hello Barney.The bird in the word./nThis is after a new line.",
                    {
                        only: ["sentence:start"]
                    },
                    done,
        ...
        describe("End", function () {
            it("should detect sentences not ending with a space before punctuation", function (done) {
                testRousseau(
                    "Hello Barney. The bird in the word .",
                    {
                        only: ["sentence:end"]
                    },
                    done,
